...
public class ListItems extends JPanel {
    ...
    private src2.panel.Button[] itemPanels = null;
    ...
    public ListItems(int x, int y, int width, int height, int rootLocationType, String[] texts) {
        ...
        setItemTextFont(src2.panel.Button.ARIAL_BOLD_18);
    ...
    public void updatePanelScroll() {
        ...
        // Create item panels
        int heightScroll = 0;
        this.itemPanels = new src2.panel.Button[this.itemTexts.length];
        for (int i = 0; i < itemPanels.length; i++) {
            itemPanels[i] = new src2.panel.Button(itemTexts[i]);
            ...
            itemPanels[i].setLocationButton(0, heightScroll, src2.panel.Button.TOP_LEFT);
