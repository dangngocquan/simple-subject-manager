...
import src.Setting;
import src.dialog.DialogUpdateStatusSubject;
...
public class PanelUpdateStatusSubject extends JPanel {
        ...
        public PanelUpdateStatusSubject(int x, int y, int width, int height, Plan plan, int indexPlan,
                ...
                contentPanel.setBounds(STROKE_WIDTH, headerPanel.getHeight() + 2 * STROKE_WIDTH,
                ...
                titleOrder.setFontText(
                                new Font(Setting.FONT_NAME_01, Setting.FONT_STYLE_01, Setting.FONT_SIZE_SMALL_2));
                ...
                titleStatus.setSizeButton(
                                headerPanel.getWidth() - titleOrder.getWidth() - titleCode.getWidth()
                                                - titleName.getWidth()
                ...
                panelInfors[2] = new PanelString(5, tempHeight,
                                "Số môn học đã hoàn thành: " + plan.getNumberSubjectCompleted(),
                                summaryPanel.getWidth(), null, PanelString.TOP_LEFT, 15);
                ...
                panelInfors[3] = new PanelString(5, tempHeight,
                                "Số tín chỉ đã hoàn thành: " + plan.getNumberCreditCompleted(),
                                summaryPanel.getWidth(), null, PanelString.TOP_LEFT, 15);
                ...
                panelInfors[4] = new PanelString(5, tempHeight,
                                "Số môn học đã đăng kí: " + plan.getNumberSubjectRegistered(),
                                summaryPanel.getWidth(), null, PanelString.TOP_LEFT, 15);
                ...
                panelInfors[5] = new PanelString(5, tempHeight,
                                "Số tín chỉ đã đăng kí: " + plan.getNumberCreditRegistered(),
                                summaryPanel.getWidth(), null, PanelString.TOP_LEFT, 15);
                        ...
                        for (int i = 0; i < panelSubjects.length; i++) {
                                if (e.getSource() == panelSubjects[i]) {
                                        if (plan.getSubjects().get(i).getState() != Subject.COMPLETED) {
                                                DialogUpdateStatusSubject dialog = new DialogUpdateStatusSubject(
                                                                Setting.WIDTH / 2,
                                                                Setting.HEIGHT / 2,
                                                                Setting.WIDTH / 3 * 2, Setting.HEIGHT / 5 * 4,
                                                                DialogUpdateStatusSubject.CENTER_CENTER,
                                                                "Update status subject", (new String[] {}),
                        ...
                        for (int count = 0; count < panelSubjects.length; count++) {
                                if (e.getSource() == panelSubjects[count]) {
                                        if (plan.getSubjects().get(count).getState() != Subject.COMPLETED) {
                                                panelSubjects[count]
                                                                .setBackgroundColorPanelSubject(COLOR_SUBJECT_ENTERED);
                                        }
                                }
                        }
                        repaint();
                ...
                public void mouseExited(MouseEvent e) {
                        for (int count = 0; count < panelSubjects.length; count++) {
                                if (e.getSource() == panelSubjects[count]) {
                                        if (count % 2 == 0) {
                                                panelSubjects[count]
                                                                .setBackgroundColorPanelSubject(COLOR_SUBJECT_EXITED_1);
                                        } else {
                                                panelSubjects[count]
                                                                .setBackgroundColorPanelSubject(COLOR_SUBJECT_EXITED_2);
                                        }
                                }
                        }
                        repaint();
