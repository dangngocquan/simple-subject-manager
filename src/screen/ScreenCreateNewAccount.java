                        ...
                        if (event.getSource() == buttons[0]) {
                                if (fieldName.getText().isEmpty() ||
                                        ...
                                        new DialogMessage(Setting.WIDTH / 2, Setting.HEIGHT / 2, Setting.WIDTH / 3,
                                                        ...
                                                        "Information", new String[] { "Bạn chưa nhập Họ và tên." },
                                                        Setting.WARNING);
                                        ...
                                        new DialogMessage(Setting.WIDTH / 2, Setting.HEIGHT / 2, Setting.WIDTH / 3,
                                                        Setting.HEIGHT / 3,
                                                        DialogMessage.CENTER_CENTER,
                                                        "Information", new String[] { "Bạn chưa nhập Tên đăng nhập." },
                                                        Setting.WARNING);
                                        ...
                                        new DialogMessage(Setting.WIDTH / 2, Setting.HEIGHT / 2, Setting.WIDTH / 3,
                                                        ...
                                                        DialogMessage.CENTER_CENTER,
                                                        "Information",
                                                        new String[] { "Tên đăng nhập đã được sử dụng." },
                                                        Setting.WARNING);
                                        ...
                                        new DialogMessage(Setting.WIDTH / 2, Setting.HEIGHT / 2, Setting.WIDTH / 3,
                                                        Setting.HEIGHT / 3,
                                                        DialogMessage.CENTER_CENTER,
                                                        "Information", new String[] { "Bạn chưa thiết lập mật khẩu." },
                                                        Setting.WARNING);
                                } else {
                                        WriteFile.createNewAccount(new Account(
                                                        fieldName.getText(), fieldUsername.getText(),
                                                        fieldPassword.getText()));
                                        WriteFile.writeStringToFile(ReadFile.PATH_DATA_TEMP_1, fieldUsername.getText(),
                                                        false);
                                        new DialogMessage(Setting.WIDTH / 2, Setting.HEIGHT / 2, Setting.WIDTH / 3,
                                                        Setting.HEIGHT / 3,
                                                        DialogMessage.CENTER_CENTER,
