...
public class ListItemsDrop extends JPanel {
    ...
    private Button buttonArrow = null;
    private Button panelShowingText = null;
    ...
    public ListItemsDrop(int x, int y, int widthListItems, int heightListItems, int rootLocationType, String[] texts) {
        ...
        panelShowingText = new Button(texts[0]);
        ...
        panelShowingText.setLocationButton(0, 0, Button.TOP_LEFT);
        ...
        buttonArrow.setLocationButton(panelShowingText.getWidth(), panelShowingText.getY(), Button.TOP_LEFT);
