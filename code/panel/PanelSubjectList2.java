...
import code.Setting;
import code.dialog.DialogCreateNewSubject;
...
public class PanelSubjectList2 extends JPanel {
    ...
    public PanelSubjectList2(int x, int y, int width, int height, Plan plan, int rootLocationType, int indexPlan) {
        ...
        buttonAddNewSubject.setFontText(new Font(Setting.FONT_NAME_01, Setting.FONT_STYLE_01, Setting.FONT_SIZE_BIG));
        ...
        buttonAddNewSubject.setGradientBackgroundColorExited(Setting.GRADIENT_POINTS1_5, Setting.GRADIENT_POINTS2_5,
                Setting.GRADIENT_COLORS_5);
        buttonAddNewSubject.setGradientBackgroundColorEntered(Setting.GRADIENT_POINTS1_8, Setting.GRADIENT_POINTS2_8,
        ...
        for (Subject subject : this.plan.getTimeTable().getSubjects()) {
            ...
            buttonSubject.setFontText(new Font(Setting.FONT_NAME_01, Setting.FONT_STYLE_01, Setting.FONT_SIZE_SMALL));
            ...
            buttonSubject.setGradientBackgroundColor(Setting.GRADIENT_POINTS1_5, Setting.GRADIENT_POINTS2_5,
                    Setting.GRADIENT_COLORS_5);
            buttonSubject.setGradientBackgroundColorExited(Setting.GRADIENT_POINTS1_5, Setting.GRADIENT_POINTS2_5,
                    Setting.GRADIENT_COLORS_5);
            buttonSubject.setGradientBackgroundColorEntered(Setting.GRADIENT_POINTS1_8, Setting.GRADIENT_POINTS2_8,
                    Setting.GRADIENT_COLORS_8);
            buttonSubject.setSizeButton((int) (width / 7.0 * 4 * 3 / 5), buttonSubject.getHeight());
            buttonSubject.setSizeButton(buttonSubject.getWidth(), (int) (buttonSubject.getWidth() * Math.sqrt(3) / 2));
            buttonSubject.setBounds(width / 7, heightScroll, buttonSubject.getWidth(), buttonSubject.getHeight());
            ...
            buttonCountTimeLesson.setGradientBackgroundColor(Setting.GRADIENT_POINTS1_5, Setting.GRADIENT_POINTS2_5,
                    Setting.GRADIENT_COLORS_5);
            ...
            buttonCountTimeLesson.setLocationButton(
                    buttonSubject.getX() + (int) (buttonCountTimeLesson.getWidth() / 4.0), heightScroll,
                    Button.TOP_RIGHT);
    ...
    private class MouseHandler implements MouseListener {
        ...
        public void mousePressed(MouseEvent event) {
            if (event.getSource() == buttonAddNewSubject) {
                new DialogCreateNewSubject(Setting.WIDTH / 2, Setting.HEIGHT / 2, Setting.WIDTH / 3, Setting.HEIGHT / 3,
                        DialogCreateNewSubject.CENTER_CENTER, "Add new subject", new String[] {}, plan,
                        indexPlan);
                updateDataContent();
            }
        }
