...
public class DialogChangePassword {
    ...
    public DialogChangePassword(int x, int y, int width, int height, int rootLocationType, String title,
        ...
        oldPassword = new TextField(width / 20, tempHeight,
                width / 20 * 18, 50, "Mật khẩu hiện tại", 2, 15, 15);
        tempHeight += oldPassword.getHeight() + 10;
        newPassword = new TextField(width / 20, tempHeight,
                width / 20 * 18, 50, "Mật khẩu mới", 2, 15, 15);
        tempHeight += newPassword.getHeight() + 10;
        confirmNewPassword = new TextField(width / 20, tempHeight,
                width / 20 * 18, 50, "Xác nhận mật khẩu mới", 2, 15, 15);
